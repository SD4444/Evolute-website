...
export async function generateMetadata(props: PageProps<"/services/investors/[slug]">) {
...
export default async function InvestorServicePage(props: PageProps<"/services/investors/[slug]">) {
  const { slug } = await props.params;
  const service = findService("investors", slug);
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,0.55fr)_minmax(0,1.45fr)] lg:gap-20">
            <div className="flex flex-col gap-4">
              ...
              <p className="max-w-md text-base text-navy-600 md:text-lg">
                Discovery, Design, Build, Execute: structured work that fits the rhythm of an
                investment process.
              </p>
            </div>
            <DisclosureList
