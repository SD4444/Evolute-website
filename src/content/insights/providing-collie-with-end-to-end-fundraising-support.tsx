...
export default function Body() {
  return (
    <div className="flex flex-col gap-6">
      ...
      <p className="text-base leading-relaxed text-gray-500 md:text-lg">
        The Collie collar uses gentle techniques to train cows to respond to sounds and vibrations.
        Through this cow training process and within a matter of days, farmers are able to monitor,
        move, and contain cows anywhere on their farm using their smartphone. Their technology
        replaces traditional fencing, reducing labor, improving animal welfare, and enhancing milk
        production.
      </p>
      <p className="text-base leading-relaxed text-gray-500 md:text-lg">
        Collie&apos;s solution cuts daily labor by up to three hours, improves grazing efficiency,
      ...
      <p className="text-base leading-relaxed text-gray-500 md:text-lg">
        Before working with us, Collie had established a small network of interested VC firms,
        corporate VCs, and angel investors, but struggled to convert interest into firm commitments.
        Despite engaging with investors, closing deals remained their primary obstacle. Seeking
        support in preparation, investor relations, and deal execution, Collie approached us to
        enhance their fundraising efforts. Upon review, we identified critical gaps in their
        investment deck, financial model, and other supporting materials, which required refinement
        to strengthen their approach. By addressing these opportunities, we improved Collie&apos;s
      ...
      <p className="text-base leading-relaxed text-gray-500 md:text-lg">
        To support Collie in securing their funding, we conducted a one-month preparation phase,
        refining their investment materials and financial model to strengthen their positioning.
        Over the following two months, we actively sourced well-fitting investors, expanded their
        network, and facilitated investor discussions.
      </p>
      ...
      <p className="text-base leading-relaxed text-gray-500 md:text-lg">
        ...
        finalized, ensuring Collie obtained the necessary funding to drive their growth.
      </p>
      <ul className="flex list-disc flex-col gap-2 pl-6 text-gray-500">
